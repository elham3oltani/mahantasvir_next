    ...
    <div className="lg:w-3/4 w-full lg:mx-auto my-20 flex flex-col lg:flex-row-reverse justify-between">
      <div className="lg:w-[30%] w-full">
        <Image
          src={trustPhoto}
          alt="photo rtust"
          className="w-[200px] lg:w-full mx-auto lg:h-[400px] h-[200px]"
        />
      </div>
      <div className="flex flex-col">
        <h1 className="lg:text-[40px] px-2 text-[20px] text-right lg:w-[400px]">
          چرا به ماهان تصویر اعتماد کنیم
        </h1>
        <p className="lg:w-[400px] text-right px-2">
